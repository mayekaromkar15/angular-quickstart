...
export class LaunchComponent implements OnInit {
  ...
  ngOnInit(): void {
    SMART.authorize({
      ...
      scope: 'user/AllergyIntolerance.read user/Coverage.read user/Observation.read user/Patient.read user/Practitioner.read user/ServiceRequest.read launch online_access openid profile',
