...
export class LaunchComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    SMART.authorize({
      ...
      scope: 'launch online_access openid profile user/AllergyIntolerance.read user/Coverage.read user/Appointment.read user/Observation.read user/Patient.read user/Practitioner.read user/ServiceRequest.read user/DocumentReference.read user/Organization.read user/Encounter.read user/Location.read user/Binary.read',
