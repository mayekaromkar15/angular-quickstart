...
export class LaunchComponent implements OnInit {
  ...
  ngOnInit(): void {
    SMART.authorize({
      ...
      scope: 'online_access user/AllergyIntolerance.read user/Coverage.read user/Observation.read user/Patient.read user/Practitioner.read user/ServiceRequest.read',
